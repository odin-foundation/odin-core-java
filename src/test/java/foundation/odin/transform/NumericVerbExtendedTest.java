 ...
 * .NET SDK NumericVerbExtendedTests.cs (Rust SDK numeric_verbs.rs extended_tests module).
 */
class NumericVerbExtendedTest {
    ...
    @Test
    void parseInt_FromFloatString_Truncates() {
    ...
    @Test
    void parseInt_NonNumeric_ReturnsNull() {
    ...
    @Test
    void isFinite_NegativeInfinity() {
    ...
    @Test void compound_Basic() { assertNumeric(invoke("compound", F(1000.0), F(0.05), I(10)), 1000.0 * Math.pow(1.05, 10), 0.01); }
    @Test void compound_ZeroRate() { assertNumeric(invoke("compound", F(1000.0), F(0.0), I(10)), 1000.0, 0.01); }
    @Test void compound_OnePeriod() { assertNumeric(invoke("compound", F(500.0), F(0.10), I(1)), 550.0, 0.01); }
    @Test void compound_LargePeriods() { assertNumeric(invoke("compound", F(100.0), F(0.07), I(30)), 100.0 * Math.pow(1.07, 30), 0.01); }
    @Test void compound_NegativeRate() { assertNumeric(invoke("compound", F(1000.0), F(-0.02), I(5)), 1000.0 * Math.pow(0.98, 5), 0.01); }
    ...
    @Test void discount_Basic() { assertNumeric(invoke("discount", F(1000.0), F(0.05), I(10)), 1000.0 / Math.pow(1.05, 10), 0.01); }
    @Test void discount_ZeroRate() { assertNumeric(invoke("discount", F(1000.0), F(0.0), I(5)), 1000.0, 0.01); }
    @Test void discount_OnePeriod() { assertNumeric(invoke("discount", F(1100.0), F(0.10), I(1)), 1000.0, 0.01); }
    @Test void discount_LargePeriods() { assertNumeric(invoke("discount", F(1000000.0), F(0.08), I(50)), 1000000.0 / Math.pow(1.08, 50), 1.0); }
    ...
    @Test void pmt_ZeroRate() { assertNumeric(invoke("pmt", F(12000.0), F(0.0), F(12.0)), 1000.0, 0.01); }
    @Test void pmt_OnePeriod() { assertNumeric(invoke("pmt", F(1000.0), F(0.1), F(1.0)), 1100.0, 0.01); }
    ...
    @Test void fv_ZeroRate() { assertNumeric(invoke("fv", F(100.0), F(0.0), F(12.0)), 1200.0, 0.01); }
    ...
    @Test void pv_ZeroRate() { assertNumeric(invoke("pv", F(1200.0), F(0.0), F(12.0)), 1200.0 * 12.0, 0.01); }
    ...
    @Test void rate_ZeroPmtGrowth() { assertNumeric(invoke("rate", F(10.0), F(0.0), F(-1000.0), F(2000.0)), 0.0718, 0.01); }
    ...
    @Test void nper_ZeroRate() { assertNumeric(invoke("nper", F(0.0), F(-100.0), F(5000.0)), 50.0, 0.01); }
    @Test void nper_MissingArgs() { assertTrue(invoke("nper", F(0.01), F(-100.0)).isNull()); }

    @Test void depreciation_Basic() { assertNumeric(invoke("depreciation", F(10000.0), F(1000.0), F(5.0)), 1800.0, 0.01); }
    @Test void depreciation_NoSalvage() { assertNumeric(invoke("depreciation", F(5000.0), F(0.0), F(10.0)), 500.0, 0.01); }
    @Test void depreciation_ZeroLife() { assertTrue(invoke("depreciation", F(5000.0), F(0.0), F(0.0)).isNull()); }
    @Test void depreciation_EqualCostSalvage() { assertNumeric(invoke("depreciation", F(5000.0), F(5000.0), F(10.0)), 0.0, 1e-10); }
    ...
    @Test void std_Basic() { assertNumeric(invoke("std", Arr(F(2), F(4), F(4), F(4), F(5), F(5), F(7), F(9))), 2.0, 0.01); }
    @Test void std_Uniform() { assertNumeric(invoke("std", Arr(F(5), F(5), F(5))), 0.0, 1e-10); }

    @Test void variance_Basic() { assertNumeric(invoke("variance", Arr(F(2), F(4), F(4), F(4), F(5), F(5), F(7), F(9))), 4.0, 0.01); }

    @Test void median_Odd() { assertNumeric(invoke("median", Arr(F(3), F(1), F(2))), 2.0, 1e-10); }
    @Test void median_Even() { assertNumeric(invoke("median", Arr(F(1), F(2), F(3), F(4))), 2.5, 1e-10); }
    @Test void median_Single() { assertNumeric(invoke("median", Arr(F(42))), 42.0, 1e-10); }

    @Test void mode_Basic() { assertNumeric(invoke("mode", Arr(F(1), F(2), F(2), F(3))), 2.0, 1e-10); }
    @Test void mode_AllSame() { assertNumeric(invoke("mode", Arr(F(7), F(7), F(7))), 7.0, 1e-10); }
    ...
    @Test void percentile_50th() { assertNumeric(invoke("percentile", Arr(F(1), F(2), F(3), F(4), F(5)), F(50.0)), 3.0, 1e-10); }
    @Test void percentile_0th() { assertNumeric(invoke("percentile", Arr(F(1), F(2), F(3)), F(0.0)), 1.0, 1e-10); }
    @Test void percentile_100th() { assertNumeric(invoke("percentile", Arr(F(1), F(2), F(3)), F(100.0)), 3.0, 1e-10); }

    @Test void quantile_Half() { assertNumeric(invoke("quantile", Arr(F(10), F(20), F(30)), F(0.5)), 20.0, 1e-10); }
    ...
    @Test void stdSample_TooFew() { assertTrue(invoke("stdSample", Arr(F(5))).isNull()); }
    ...
    @Test void formatNumber_VerySmall() { assertEquals("0.000001", invoke("formatNumber", F(0.000001), I(6)).asString()); }

    @Test
    void formatNumber_VeryLarge() {
    ...
    @Test void formatDate_YyyyMmDd() { assertEquals("2024-06-15", invoke("formatDate", S("2024-06-15"), S("YYYY-MM-DD")).asString()); }
    @Test void formatDate_MmDdYyyy() { assertEquals("06/15/2024", invoke("formatDate", S("2024-06-15"), S("MM/DD/YYYY")).asString()); }
    @Test void formatDate_DdMmYyyy() { assertEquals("15-06-2024", invoke("formatDate", S("2024-06-15"), S("DD-MM-YYYY")).asString()); }
    @Test void formatDate_FromTimestamp() { assertEquals("2024-06-15", invoke("formatDate", S("2024-06-15T14:30:00"), S("YYYY-MM-DD")).asString()); }

    @Test void formatTime_HhMmSs() { assertEquals("14:30:45", invoke("formatTime", S("2024-06-15T14:30:45"), S("HH:mm:ss")).asString()); }
    @Test void formatTime_HhMm() { assertEquals("09:05", invoke("formatTime", S("2024-06-15T09:05:00"), S("HH:mm")).asString()); }
    @Test void formatTime_Midnight() { assertEquals("00:00:00", invoke("formatTime", S("2024-06-15T00:00:00"), S("HH:mm:ss")).asString()); }
    @Test void formatTime_EndOfDay() { assertEquals("23:59:59", invoke("formatTime", S("2024-06-15T23:59:59"), S("HH:mm:ss")).asString()); }

    // =========================================================================
    // 21. DATETIME: PARSE_DATE
    // =========================================================================

    @Test void parseDate_Basic() { assertEquals("2024-06-15", invoke("parseDate", S("06/15/2024"), S("MM/DD/YYYY")).asString()); }
    @Test void parseDate_European() { assertEquals("2024-06-15", invoke("parseDate", S("15-06-2024"), S("DD-MM-YYYY")).asString()); }

    // =========================================================================
    // 22. DATETIME: ADD MONTHS / YEARS
    // =========================================================================

    @Test void addMonths_Basic() { assertEquals("2024-04-15", invoke("addMonths", S("2024-01-15"), I(3)).asString()); }
    @Test void addMonths_YearBoundary() { assertEquals("2025-02-15", invoke("addMonths", S("2024-11-15"), I(3)).asString()); }
    @Test void addMonths_Negative() { assertEquals("2023-12-15", invoke("addMonths", S("2024-03-15"), I(-3)).asString()); }
    @Test void addMonths_JanToFebClamp() { assertEquals("2024-02-29", invoke("addMonths", S("2024-01-31"), I(1)).asString()); }
    @Test void addMonths_JanToFebNonLeap() { assertEquals("2023-02-28", invoke("addMonths", S("2023-01-31"), I(1)).asString()); }
    @Test void addMonths_Twelve() { assertEquals("2025-06-15", invoke("addMonths", S("2024-06-15"), I(12)).asString()); }
    @Test void addMonths_Zero() { assertEquals("2024-06-15", invoke("addMonths", S("2024-06-15"), I(0)).asString()); }
    @Test void addMonths_LargeNegative() { assertEquals("2022-06-15", invoke("addMonths", S("2024-06-15"), I(-24)).asString()); }
    @Test void addMonths_InvalidDate() { assertTrue(invoke("addMonths", S("not-a-date"), I(1)).isNull()); }

    @Test void addYears_Basic() { assertEquals("2029-06-15", invoke("addYears", S("2024-06-15"), I(5)).asString()); }
    @Test void addYears_Negative() { assertEquals("2021-06-15", invoke("addYears", S("2024-06-15"), I(-3)).asString()); }
    @Test void addYears_LeapDay() { assertEquals("2025-02-28", invoke("addYears", S("2024-02-29"), I(1)).asString()); }
    @Test void addYears_LeapDayToLeap() { assertEquals("2028-02-29", invoke("addYears", S("2024-02-29"), I(4)).asString()); }
    @Test void addYears_Zero() { assertEquals("2024-06-15", invoke("addYears", S("2024-06-15"), I(0)).asString()); }
    @Test void addYears_InvalidDate() { assertTrue(invoke("addYears", S("not-a-date"), I(1)).isNull()); }
    ...
    @Test void startOfMonth_Basic() { assertEquals("2024-06-01", invoke("startOfMonth", S("2024-06-15")).asString()); }
    @Test void endOfMonth_June() { assertEquals("2024-06-30", invoke("endOfMonth", S("2024-06-15")).asString()); }
    @Test void endOfMonth_FebLeap() { assertEquals("2024-02-29", invoke("endOfMonth", S("2024-02-10")).asString()); }
    @Test void endOfMonth_FebNonLeap() { assertEquals("2023-02-28", invoke("endOfMonth", S("2023-02-10")).asString()); }
    @Test void endOfMonth_December() { assertEquals("2024-12-31", invoke("endOfMonth", S("2024-12-05")).asString()); }
    @Test void endOfMonth_January() { assertEquals("2024-01-31", invoke("endOfMonth", S("2024-01-15")).asString()); }
    @Test void endOfMonth_March() { assertEquals("2024-03-31", invoke("endOfMonth", S("2024-03-01")).asString()); }
    @Test void endOfMonth_April() { assertEquals("2024-04-30", invoke("endOfMonth", S("2024-04-01")).asString()); }

    @Test void startOfYear_Basic() { assertEquals("2024-01-01", invoke("startOfYear", S("2024-06-15")).asString()); }
    @Test void endOfYear_Basic() { assertEquals("2024-12-31", invoke("endOfYear", S("2024-06-15")).asString()); }
    ...
    @Test void weekOfYear_Jan1() { assertNumeric(invoke("weekOfYear", S("2024-01-01")), 1.0, 1e-10); }

    @Test
    void weekOfYear_Dec31() {
        var result = invoke("weekOfYear", S("2024-12-31"));
        Double d = result.asDouble();
        Long i = result.asInt64();
        Double v = d != null ? d : (i != null ? (double) i : null);
        assertNotNull(v);
        assertTrue(v >= 1 && v <= 53, "week=" + v);
    }

    @Test void quarter_Q1() { assertNumeric(invoke("quarter", S("2024-02-15")), 1.0, 1e-10); }
    @Test void quarter_Q2() { assertNumeric(invoke("quarter", S("2024-06-15")), 2.0, 1e-10); }
    @Test void quarter_Q3() { assertNumeric(invoke("quarter", S("2024-09-15")), 3.0, 1e-10); }
    @Test void quarter_Q4() { assertNumeric(invoke("quarter", S("2024-12-15")), 4.0, 1e-10); }
    @Test void quarter_InvalidDate() { assertTrue(invoke("quarter", S("bad-date")).isNull()); }
    ...
    @Test void isBetween_Timestamps() { assertEquals(true, invoke("isBetween", S("2024-06-15T12:00:00"), S("2024-06-15T00:00:00"), S("2024-06-15T23:59:59")).asBool()); }
    ...
    @Test void daysBetween_FullLeapYear() { assertNumeric(invoke("daysBetweenDates", S("2024-01-01"), S("2025-01-01")), 366.0, 1e-10); }
    @Test void daysBetween_FullNonLeapYear() { assertNumeric(invoke("daysBetweenDates", S("2023-01-01"), S("2024-01-01")), 365.0, 1e-10); }
